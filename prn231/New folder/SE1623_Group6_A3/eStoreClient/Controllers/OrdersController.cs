...
*/
        ...
        public async Task<IActionResult> Create()
        {
            ...
            items = System.Text.Json.JsonSerializer.Deserialize<List<Member>>(strData, options);

           
            ViewData["MemberId"] = new SelectList(items, "MemberId", "MemberId");
        ...
        public async Task<IActionResult> CreateDetaills(int? id)
        {
            ...
            ProductApiUrl = "https://localhost:7063/Product/Product";
            ...
            items = System.Text.Json.JsonSerializer.Deserialize<List<Product>>(strData, options);




            ViewData["ProductId"] = new SelectList(items, "ProductId", "ProductId");
